...
pipeline {
    ...
    stages {
        ...
        stage('SonarQube analysis') {
            steps {
                sh '/opt/sonar-scanner/bin/sonar-scanner -Dsonar.projectKey=QRCODE-API -Dsonar.sources=. -Dsonar.host.url=http://dockerlab:9000 -Dsonar.login=squ_924168670f71ab32440fda9ced08771703722cfd'
            }
        }
